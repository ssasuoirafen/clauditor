---
name: audit-recon
description: Read-only inventory + reality baseline for a .claude/ audit. Returns the Baseline JSON. Use as the first step of /audit-claude.
...
1. Read `${CLAUDE_PLUGIN_ROOT}/skills/audit-claude/references/profile.md` and `references/checks/recon.md`.
